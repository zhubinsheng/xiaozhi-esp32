...
// GPIO35-37: 你的板子上用于Flash存储
// GPIO38: 你的板子上用于RGB LED


// 扬声器I2S配置
#define AUDIO_I2S_GPIO_BCLK GPIO_NUM_15  // 扬声器Bit Clock
#define AUDIO_I2S_GPIO_DOUT GPIO_NUM_16  // 扬声器数据输出
#define AUDIO_I2S_GPIO_WS   GPIO_NUM_17  // 扬声器Word Select

// INMP441 I2S麦克风配置 (BCLK/WS/DIN)
// 说明: INMP441 是 I2S 数字麦，需要标准 I2S 三线
// 建议映射: BCLK=GPIO14, WS=GPIO38, DIN=GPIO16（可按需要调整）
#define AUDIO_MIC_I2S_BCLK  GPIO_NUM_40
#define AUDIO_MIC_I2S_WS    GPIO_NUM_41
#define  AUDIO_MIC_I2S_DIN   GPIO_NUM_42

// 用户交互
#define BOOT_BUTTON_GPIO        GPIO_NUM_0
#define BUILTIN_LED_GPIO        GPIO_NUM_48

#define VOLUME_UP_BUTTON_GPIO   GPIO_NUM_11
...
#define PRESSURE_SENSOR_ADC_RIGHT_CHANNEL ADC_CHANNEL_4  // GPIO18 (ADC1_CHANNEL_4)
